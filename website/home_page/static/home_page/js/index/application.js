...
(function() {
  ...
  getCorsUrl = function() {
    ...
    if (host === 'developer-dev.txu.io') {
      return '';
    } else {
      return 'https://developer.txu.io';
    }
  };
  ...
  setSEORefer = function() {
    ...
    if (ref && ref.length > 0 && ref.indexOf('txu.com') < 0 && ref.indexOf('txu.io') < 0) {
      expire = new Date();
      expire.setDate(expire.getDate() + 3);
      return document.cookie = 'txu_seo_refer=' + ref + ';domain=.txu.com;path=/;expires=' + expire;
    }
  };
  ...
  $(function() {
    var $contentInput, $emailInput, $navul, articleSearch, checkBtnEnable, clipboard, codeBar, count, createPages, createSearchSide, debounce, feedbackbtn, getSearchURL, hash, keyword, keywordIndex, left, pagenum, path, ratingChange, searchKeywords, sidebarElem, space, validateEmail;
    $('body').on('click', "a", function(e) {
      var connector, firstdomain, host, hostname, href, ref;
      setSEORefer();
      href = $(this).prop('href');
      if (href !== "javascript:;") {
    ...
    if (isMobile) {
      $('#spaces-dropdown, #sdk-dropdown, #user-dropdown, #more-dropdown').on("tap", function() {
        return $(this).toggleClass('open');
      });
    } else {
      $('#spaces-dropdown, #sdk-dropdown, #user-dropdown, #more-dropdown').hover(function() {
    ...
    searchKeywords = function(e) {
      ...
      return $.ajax({
        url: 'https://support.txu.com/action/search/prefix?content=' + keyword,
        jsonp: 'callback',
        dataType: 'jsonp',
    ...
    articleSearch = function() {
      ...
      if (searchlist.length > 0) {
        return $.ajax({
          url: 'https://support.txu.com/action/search/doc?limit=15&content=' + keyword + '&page=' + pagenum + '&space=' + space,
          jsonp: 'callback',
          dataType: 'jsonp',
          success: function(response) {
            ...
            for (k = j = 0, len = ref1.length; j < len; k = ++j) {
              ...
              tmp.find(".title a").attr("href", 'javascript:;');
